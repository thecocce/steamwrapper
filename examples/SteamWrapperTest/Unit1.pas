...
var
  ...
  procedure OnCreateItemResult(eResult: TResult; PublishedFileId: uint64; bUserNeedsToAcceptWorkshopLegalAgreement: boolean); cdecl;
...
procedure OnSteamUGCQueryCompleted(Handle: uint64; eResult: TResult; NumResultsReturned, TotalMatchingResults: uint32; CachedData: boolean); cdecl;
begin
  log('Callback: QueryCompleted  handle=' + handle.ToString) ;
end;

procedure OnSteamUGCRequestUGCDetailsResult(Details: TSteamUGCDetails; CachedData: boolean); cdecl;
begin
...
var
  ...
  ret : Integer;
begin
  hd := SteamUGC_CreateQueryAllUGCRequest(1,0,SteamUtils_GetAppID,SteamUtils_GetAppID,1);
  ret := SteamUGC_SendQueryUGCRequest( hd ) ;
  log('Begin Test Send UGC Query ... hd=' + hd.ToString + '   ret=' + ret.ToString );
...
begin
  ...
  SteamCallbacks.OnSteamUGCRequestUGCDetailsResult := OnSteamUGCRequestUGCDetailsResult;
